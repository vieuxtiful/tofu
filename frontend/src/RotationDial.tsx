...
export default function RotationDial({ value, onChange, onReset }: RotationDialProps) {
  ...
  return (
    <span className="flex flex-col items-center gap-0.5">
      <svg
        ...
        className="cursor-crosshair rounded-full border border-zinc-300 bg-zinc-50 touch-none dark:border-zinc-700 dark:bg-zinc-900"
      ...
      <input
        ...
        onDoubleClick={onReset}
        className="w-16 rounded border border-zinc-300 bg-white px-1 py-0.5 text-right font-mono text-[10px] text-zinc-800 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-200"
      />
    </span>
  );
}
